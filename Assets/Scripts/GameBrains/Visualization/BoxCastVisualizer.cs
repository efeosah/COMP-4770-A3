...
namespace GameBrains.Visualization
{
    #if UNITY_EDITOR
    [FilePath(
        "ScriptableObjects/Visualizers/BoxCastVisualizer",
        FilePathAttribute.Location.ProjectFolder)]
    [CreateAssetMenu(
        fileName = "BoxCastVisualizer",
        menuName = "GameBrains/Visualization/BoxCastVisualizer")]
    #endif
    public class BoxCastVisualizer : CastVisualizer
    {
        ...
        {
            visualizerPrefab
                = Resources.Load<GameObject>("Prefabs/Visualization/BoxCastVisualizerPrefab");
            visualizerObject = Instantiate(visualizerPrefab);
            visualizerObject.name = "BoxCastVisualizer";
